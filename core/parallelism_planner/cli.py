...
def _resolve_mock_topology(choice: str, mock_gpus: int = 4):
    from providers.advisor import create_mock_topology_b200_multigpu, create_mock_topology_h100_multigpu
...
def cmd_recommend(args):
    ...
    from .providers.advisor import ParallelismAdvisor
...
def cmd_sharding(args):
    ...
    from .providers.model_analyzer import ModelAnalyzer
    from .providers.sharding_strategies import ShardingOptimizer
...
def cmd_launch(args):
    ...
    from .providers.launch_commands import LaunchCommandGenerator, LaunchConfig, ShardingStrategy
...
def cmd_pareto(args):
    ...
    from .providers.advisor import ParallelismAdvisor
    from .providers.pareto_analysis import ParetoAnalyzer, ConfigurationPoint
...
def cmd_calibrate(args):
    ...
    from .providers.calibration import CalibrationEngine
...
def cmd_presets(args):
    ...
    from .providers.model_analyzer import ModelAnalyzer, MODEL_PRESETS
...
def cmd_topology(args):
    ...
    from .providers.topology_detector import TopologyDetector
...
def cmd_estimate(args):
    ...
    from .providers.extras import TrainingEstimator
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_compare(args):
    ...
    from .providers.extras import ModelComparator
    from .providers.topology_detector import TopologyDetector
...
def cmd_slurm(args):
    ...
    from .providers.extras import JobScriptGenerator
...
def cmd_validate(args):
    ...
    from .providers.validation import validate_full_configuration, ConfigValidator
    from .providers.model_analyzer import ModelAnalyzer
    from .providers.advisor import ParallelismAdvisor
...
def cmd_dryrun(args):
    ...
    from .providers.validation import DryRunner
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_optimize(args):
    ...
    from .providers.advanced_optimizations import get_advanced_optimization_report
    from .providers.model_analyzer import ModelAnalyzer
    from .providers.advisor import ParallelismAdvisor
...
def cmd_profile(args):
    ...
    from .providers.performance_profiles import get_performance_profile, list_available_profiles
    from .providers.advisor import ParallelismAdvisor
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_bottleneck(args):
    ...
    from .providers.bottleneck_analysis import analyze_bottlenecks
    from .providers.model_analyzer import ModelAnalyzer
    from .providers.advisor import ParallelismAdvisor
...
def cmd_scaling(args):
    ...
    from .providers.bottleneck_analysis import analyze_scaling
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_whatif(args):
    ...
    from .providers.bottleneck_analysis import analyze_whatif
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_batchsize(args):
    ...
    from .providers.auto_tuning import find_max_batch_size
    from .providers.model_analyzer import ModelAnalyzer
    from .providers.advisor import ParallelismAdvisor
...
def cmd_autotune(args):
    ...
    from .providers.auto_tuning import auto_tune_config
    from .providers.model_analyzer import ModelAnalyzer
    from .providers.advisor import ParallelismAdvisor
...
def cmd_inference(args):
    ...
    from .providers.inference_optimization import get_inference_optimization_report
    from .providers.model_analyzer import ModelAnalyzer
    from .providers.advisor import ParallelismAdvisor
...
def cmd_troubleshoot(args):
    ...
    from .providers.troubleshooting import (
...
def cmd_memory(args):
    ...
    from .providers.troubleshooting import get_memory_breakdown
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_nccl(args):
    ...
    from .providers.distributed_training import NCCLTuningAdvisor
...
def cmd_rlhf(args):
    ...
    from .providers.distributed_training import RLHFMemoryCalculator, RLHFAlgorithm
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_moe(args):
    ...
    from .providers.distributed_training import MoEOptimizer
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_long_context(args):
    ...
    from .providers.distributed_training import LongContextOptimizer
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_vllm(args):
    ...
    from .providers.distributed_training import VLLMConfigGenerator
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_comm_overlap(args):
    ...
    from .providers.distributed_training import CommunicationOverlapAnalyzer
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_export(args):
    ...
    from .providers.config_export import export_training_config, ConfigExporter
    from .providers.model_analyzer import ModelAnalyzer
    ...
    if args.output_dir:
        ...
        from .providers.config_export import ExportedConfig
...
def cmd_rl(args):
    ...
    from .providers.rl_optimization import get_rl_optimization, RLAlgorithm
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_vllm(args):
    """Handle vllm subcommand."""
    from .providers.vllm_optimization import get_vllm_optimization
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_llm_advisor(args):
    ...
    from .providers.llm_advisor import LLMOptimizationAdvisor, SystemContext, OptimizationRequest, OptimizationGoal
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_nccl(args):
    """Handle nccl subcommand."""
    from .providers.troubleshooting import get_nccl_tuning
...
def cmd_rlhf(args):
    ...
    from .providers.rl_optimization import get_rl_optimization
    from .providers.model_analyzer import ModelAnalyzer
...
def cmd_moe(args):
    """Handle moe subcommand."""
    from .providers.model_analyzer import ModelAnalyzer
    from .providers.strategy_optimizer import StrategyOptimizer
...
def cmd_largescale(args):
    ...
    from .providers.large_scale_optimization import get_large_scale_optimization
    from .providers.model_analyzer import ModelAnalyzer
