...
from tools.hwgpu_probing.arch_config import configure_optimizations as _configure_arch_optimizations
...
def precompile_extensions():
    ...
    try:
        from tools.cuda_extensions import (
    ...
    try:
        from tools.cuda_extensions import load_graph_bandwidth_extension
